...
public class TapChiCongSanCN {
    ...
    public static String getCurrentDirectory(String pageName) {
        String directory = "";
        switch (pageName) {
            case "http://cn.tapchicongsan.org.vn/Home/Political":
                directory = "tapchicongsanCN/news";
                break;
            case "http://cn.tapchicongsan.org.vn/Home/party":
                directory = "tapchicongsanCN/politics";
                break;
            case "http://cn.tapchicongsan.org.vn/Home/economic":
                directory = "tapchicongsanCN/economic";
                break;
            case "http://cn.tapchicongsan.org.vn/Home/social":
                directory = "tapchicongsanCN/social";
                break;
            case "http://cn.tapchicongsan.org.vn/Home/TheWorld":
                directory = "tapchicongsanCN/theworld";
                break;
    ...
    public void init(String pageName, int articleSize) {
        ...
        System.out.println("Start download TapChiCongSanCN: " + pageName);
    }
...
//                      System.exit(0);
 ...
 public void saveArticle(String name, Article a) throws UnsupportedEncodingException, IOException {
    ...
    public static void main(String[] args) throws JSONException {
        TapChiCongSanCN v = new TapChiCongSanCN();
        v.init("http://cn.tapchicongsan.org.vn/Home/Political");
