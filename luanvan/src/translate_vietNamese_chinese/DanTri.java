...
//            System.out.println(doc1.select("div.container div#ctl00_IDContent_ctl00_divContent > h1").first().text());
//                System.exit(0);
            if (doc1.select("div.container div#ctl00_IDContent_ctl00_divContent > div#divNewsContent").isEmpty()) {
                return false;
            }
            ar.setContent(doc1.select("div.container div#ctl00_IDContent_ctl00_divContent > div#divNewsContent").first().text());
 //           System.out.println(doc1.select("div.container div#ctl00_IDContent_ctl00_divContent > div#divNewsContent").first().text());
//            System.exit(0);
            return true;
